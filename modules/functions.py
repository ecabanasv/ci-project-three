...
class Functions:
    ...
    def questionary_result(points):
        ...
        if points >= 0 and points <= 2:
            print(Fore.WHITE + "  (Low) You scored " + str(points) + " points.",
            "You are the new Terminator model Roomba TX6000")
        elif points > 2 and points <= 5:
            print(Fore.WHITE + "  (Medium) You scored " + str(points) + " points.",
            "We suppose that you are 'normal'")
        elif points > 5 and points <= 8:
            print(Fore.WHITE + "  (High) You scored " + str(points) + " points.",
            "Don't do today what you can do tomorrow!")
        else:
            print(Fore.WHITE + "  (Extreme) You scored " + str(points) + " points.",
